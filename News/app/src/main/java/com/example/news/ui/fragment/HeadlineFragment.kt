...
class HeadlineFragment : Fragment(R.layout.fragment_headlines) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewItemError = inflater.inflate(R.layout.item_error, null)

        retryButton = viewItemError.findViewById(R.id.retryButton)
        errorText = viewItemError.findViewById(R.id.errorText)
        ...
        newsAdapter.setOnItemClickListener {
            ...
            navController.navigate(R.id.action_headlinesFragment_to_articleFragment, bundle)
        }
            ...
            when (response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { news ->
                        ...
                        val totalPages = news.totalResults / Constants.QUERY_PAGE_SIZE
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate =
                !isError && isNotLoadingAndNotLastPage && isAtLastItem && isNotAtBeginning
